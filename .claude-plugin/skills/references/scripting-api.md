...
name: scripting-api
description: >-
  Reference for API Check scripting: HTTP request steps, selectors, variables, assertions, and authentication. Used by monitoring-setup and check-management skills.
---
...
Selectors extract values from response bodies. The format depends on content type (auto-detected from `Content-Type` header):
